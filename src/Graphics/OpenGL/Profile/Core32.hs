...
module Graphics.OpenGL.Profile.Core32 (
...
glFramebufferTexture :: (MonadIO m, MonadReader e m, HasScope e) => GLenum -> GLenum -> GLuint -> GLint -> m ()
glFramebufferTexture v0 v1 v2 v3 = funGL 2767 >>= \f -> liftIO $ f v0 v1 v2 v3
